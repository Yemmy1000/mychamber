...
def MatterListJson_2(request):
    ...
    # matters_list = list(matters)  # important: convert the QuerySet to a list object
    # return JsonResponse(matters_list, safe=False)
...
@login_required(login_url='login')
def UpdateMatterInfo(request, file_no):
    matterInfo = MatterInfo.objects.get(file_no=file_no)
