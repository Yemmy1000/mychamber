...
class MatterInfo(models.Model):
    ...
    claim_no: str = models.CharField('Case/Suit Number', max_length=200, blank=True)
...
class MatterFactDocument(models.Model):
    file_no = models.ForeignKey(MatterInfo, on_delete=models.CASCADE, null=True)
    document_category = models.CharField('Document category', max_length=250, null=True, blank=True)
    document = models.ImageField('', null=True, blank=True, upload_to=upload_to)
    case_type = models.CharField('Case type', max_length=200)
...
class NatureOfClaim(models.Model):
    file_no = models.ForeignKey(MatterInfo, on_delete=models.CASCADE, null=True)
    nature_of_claim = models.CharField("Nature of claim", max_length=200)
    category = models.CharField('Case category', max_length=250, null=True, blank=True)
